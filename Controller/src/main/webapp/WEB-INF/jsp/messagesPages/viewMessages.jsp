...
<table align="center" border="2" width="70%" cellpadding="2">
    <tr>
        ...
        <th>
            <form method="post" action="savefiltersenderUser${url}">
                <input name="filtervalue" type="number" min="0" max="1000"/>
            </form>
        </th>
        <th>
            <form method="post" action="savefilterreceiverUser${url}">
                <input name="filtervalue" type="number" min="0" max="1000"/>
            </form>
        </th>
        <th>
            <form method="post" action="savefiltermessage${url}">
                <input name="filtervalue" type="text" size="50"/>
            </form>
        </th>
        <th>
            <form method="post" action="savefiltersendTime${url}">
                <input name="filtervalue" type="date"/>
                <input type="submit" value="Save"/>
            </form>
        </th>
        <th>
            <form method="post" action="savefilterisRead${url}">
    ...
    <tr>
        ...
        <th>Sender id<a href="changesortsenderUser,asc${url}">&#8593</a><a
                href="changesortsenderUser,desc${url}">&#8595</a><a href="changesortsenderUser,nul${url}">&#215</a></th>
        <th>Receiver id<a href="changesortreceiverUser,asc${url}">&#8593</a><a href="changesortreceiverUser,desc${url}">&#8595</a><a
                href="changesortreceiverUser,nul${url}">&#215</a></th>
        <th>Text<a href="changesortmessage,asc${url}">&#8593</a><a href="changesort{message,desc}${url}">&#8595</a><a
                href="changesortmessage,nul${url}">&#215</a></th>
        <th>Send time<a href="changesortsendTime,asc${url}">&#8593</a><a href="changesortsendTime,desc${url}">&#8595</a><a
                href="changesortsendTime,nul${url}">&#215</a></th>
        <th>Is read<a href="changesortisRead,asc${url}">&#8593</a><a href="changesortisRead,desc${url}">&#8595</a><a
                href="changesortisRead,nul${url}">&#215</a></th>
        <th>Read</th>
        <th>Delete</th>
